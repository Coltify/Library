...
public class TabHandler {
    ...
    public TabHandler() {
        ...
        new TabThread().start();
        Library.getInstance().getServer().getPluginManager().registerEvents(new TabListener(), Library.getInstance());
    }
    ...
    private PropertyMap fetchSkin() {
        String propertyMap = Library.getInstance().getXJedis().runBackboneRedisCommand(redis -> redis.get("propertyMap"));
