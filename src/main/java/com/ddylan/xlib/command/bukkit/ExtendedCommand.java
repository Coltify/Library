...
import com.ddylan.xlib.command.*;
...
public class ExtendedCommand extends Command implements PluginIdentifiableCommand {
    ...
    public boolean execute(final CommandSender sender, String label, String[] args) {
        ...
        if (executionNode.canUse(sender)) {
            ...
            sender.sendMessage(Library.getInstance().getCommandHandler().getConfig().hiddenMessage());
        } else {
            sender.sendMessage(Library.getInstance().getCommandHandler().getConfig().noPermissionMessage());
        }
        return true;
    }
    ...
    public List<String> tabComplete(CommandSender sender, String cmdLine) {
        ...
        try {
            ...
            if (realNode.getParameters() != null) {
                ...
                parameterType = Library.getInstance().getCommandHandler().getParameterType(data.getType());
