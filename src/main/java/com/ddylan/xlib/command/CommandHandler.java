...
import com.ddylan.xlib.command.bukkit.ExtendedCommand;
import com.ddylan.xlib.command.bukkit.ExtendedCommandMap;
import com.ddylan.xlib.command.bukkit.ExtendedHelpTopic;
import com.ddylan.xlib.command.defaults.*;
import com.ddylan.xlib.command.parameter.*;
import com.ddylan.xlib.command.util.EasyClass;
import com.ddylan.xlib.util.ClassUtils;
...
public class CommandHandler {
    ...
    public void setConfig(CommandConfiguration configuration) {
        Library.getInstance().getCommandHandler().configuration = configuration;
    }
