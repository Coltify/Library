...
public class XTab {
    ...
    protected void update() {
        if (LibraryPlugin.getInstance().getTabHandler().getLayoutProvider() != null) {
            TabLayout tabLayout = LibraryPlugin.getInstance().getTabHandler().getLayoutProvider().provide(this.player);
            if (tabLayout == null) {
                if (this.initiated) {
                    reset();
                }
