...
public class Color {
    ...
    public static final String SCOREBAORD_SEPARATOR = Color.GRAY + Color.S + "----------------------";
    public static final String SCOREBOARD_SEPERATOR_EXTRA = Color.GRAY + Color.S + "--------------------------------";
    public static final String HORIZONTAL_SEPARATOR = Color.GRAY + Color.S + "------------------------------------------------";
    public static final String HORIZONTAL_SEPERATOR_EXTRA = Color.GRAY + Color.S + "-----------------------------------------------------";
    public static final String VERTICAL_SEPARATOR = Color.GRAY + StringEscapeUtils.unescapeJava("\u2503");
